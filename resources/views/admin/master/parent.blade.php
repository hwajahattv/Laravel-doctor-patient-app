...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{ asset('https://cdn.jsdelivr.net/npm/bootstrap@4.4.1/dist/css/bootstrap.min.css') }}"
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsecat" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        {{-- <h6 class="collapse-header">Doctors:</h6> --}}
                        <a class="collapse-item" href="{{ url('/showDoctors') }}">Doctors List</a>
                        <a class="collapse-item" href="{{ url('/adminShowAppointments') }}">Appointments List</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapsepro" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('/showPatients') }}">Patients List</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseadmin" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        {{-- <h6 class="collapse-header">Products:</h6> --}}
                        <a class="collapse-item" href="{{ url('/showAdmins') }}">Admin List</a>
                    </div>
                </div>
            </li>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <a class="btn btn-success btn-sm"
                    href="{{ asset('https://startbootstrap.com/theme/sb-admin-pro') }}">Upgrade to Pro!</a>
            </div>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="/img/Picture 917140484.jpg">
                            </a>
