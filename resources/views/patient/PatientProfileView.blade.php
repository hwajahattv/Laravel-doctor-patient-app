            ...
            <div class="row">
                <div class="col">
                    <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4 d-flex justify-content-between">
                        ...
                        <a class="btn btn-outline-primary px-5 mt-3"
                            href={{ url('/patientProfileEdit/' . Auth::id()) }}>Edit</a>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted mb-1">{{ $userInfo->designation }}</p>
                            <p class="text-muted mb-4">{{ $userInfo->city }},{{ $userInfo->country }}</p>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">{{ $userInfo->mobileNumber }}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">{{ $userInfo->address }}, {{ $userInfo->city }},
                                        {{ $userInfo->country }}</p>
                                </div>
                            </div>
                        </div>
