...
@section('content')
    <div class="alert">
        <h1 class="alert-header display-block display-3 text-center">Hello {{ $userInfo->name }}! <br />We are on your
            service.</h1>
    </div>
    <!--=================================
                =            Page Slider            =
                    ...
                    <div class="col-12">
                        ...
                        <div class="content style text-center">
                            ...
                            <p class="tag-text mb-4" data-animation-in="slideInRight">Lorem ipsum dolor sit amet consectetur
                                ...
                                numquam!</p>
                            <a href="{{ url('/team') }}" class="btn btn-main btn-white" data-animation-in="slideInLeft"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tabs mb-5">
                            <ul class="nav nav-tabs justify-content-center" id="aboutTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="sonogram-tab" data-toggle="tab" href="#sonogram"
                                        role="tab" aria-controls="sonogram" aria-selected="false">sonogram</a>
                                </li>
                                <li class="nav-item" role="presentation">
