...
<body>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 link-btn text-center text-lg-right">
                        <a href="/registerAppointment" class="btn-style-one">Make
                            an
                            appointment</a>
                    </div>
                    <div class="col-md-4">
                                    ...
                                    <figure>
                                        <a href="index.html">
                                            <img loading="lazy" class="img-fluid"
                                                src="{{ asset('images/logo-2.png') }}" alt="medic">
                                        </a>
                                    </figure>
                                </div>
                                        ...
                                        <div class="media">
                                            <div class="media-left mr-3">
                                                <a href="blog-details.html">
                                                    <img loading="lazy"
                                                        src="{{ asset('images/blog/post-thumb-small.jpg') }}"
                                                        alt="post-thumb">
                                                </a>
                                            </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-ajaxy/1.6.1/scripts/jquery.ajaxy.min.js"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" rel="javascript" type="text/javascript"></script>
